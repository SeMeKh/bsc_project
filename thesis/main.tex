...
\def\enKeywords{Behavior-Driven Development, Decoupling, Software Test Quality, Test Framework, Built-in Test}
...
\newcommand{\faKeywords}{توسعه‌ی رفتار-رانه، مستقل‌سازی، کیفیت آزمون نرم‌افزار، چارچوب آزمون، تست تو-کار}
